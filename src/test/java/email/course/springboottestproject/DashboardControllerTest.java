...
import email.course.springboottestproject.dashboard.DashboardController;
import email.course.springboottestproject.dashboard.DashboardService;
...
class DashboardControllerTest {
    ...
    public void shouldReturnViewWithPrefilledData() throws Exception {
        when(dashboardService.getAnalyticsGraphData())
